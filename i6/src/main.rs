...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let matches = App::new("i6")
        ...
        .subcommand(
            SubCommand::with_name(https_id)
                .about("Start a static https server")
                .arg(
                    Arg::with_name("port")
                        .index(1)
                        .default_value("3030")
        ...
        .subcommand(
            SubCommand::with_name(pack_id)
                .about("Compress and encrypt a folder, or decrypt and decompress an archive")
                .arg(
